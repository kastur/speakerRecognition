...
MODEL                = gaussmixp_unloop
MODULES              = gaussmixp_data.c gaussmixp.c sum.c gaussmixp_initialize.c gaussmixp_terminate.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
