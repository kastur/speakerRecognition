...
MODEL                = fi_mfcc
MODULES              = fi_mfcc_rtwutil.c fi_mfcc_initialize.c fi_mfcc_terminate.c fi_mfcc.c fi_fft.c mtimes1.c abs.c sqrt.c power1.c log.c mfcc_bare.c fft.c abs1.c sum.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = fi_mfcc_rtw.mk
...
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = /Volumes/docs/Dropbox/MFCCBenchmarks/MFCCProject
...
ADD_INCLUDES = \
	-I/Volumes/docs/Dropbox/MFCCBenchmarks/MFCCProject/codegen/lib/fi_mfcc \
	-I/Volumes/docs/Dropbox/MFCCBenchmarks/MFCCProject \
