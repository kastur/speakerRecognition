...
% (2) When merging candidates, we should keep the one with the highest
%     probability
% (3) could preserve the fixed arrays between calls if p and/or k are
%     unchanged

%      Copyright (C) Mike Brookes 2000-2012
%      Version: $Id: gaussmixg.m 2594 2012-12-12 09:25:24Z dmb $
%
